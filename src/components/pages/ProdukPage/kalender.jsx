...
const DusMakanan = () => {
  ...
  const products = [
    // produk 1
    { name: 'Kalender', 
      image: '/image/produk/kalender/moun.jpg',
      deskripsi: 'Kalender 6 lembar tipe gantungan Plat, desain full color', 
      harga: 'Rp. 7.000' },
    
    { name: 'Kalender', 
      image: '/image/produk/kalender/moun1.jpg',
      deskripsi: 'Kalender 4 lembar tipe gantungan roll, desain full color', 
      harga: 'Rp. 5.000' },
      
    { name: 'Kalender', 
      image: '/image/produk/kalender/moun2.jpg',
      deskripsi: 'Kalender 6 lembar tipe gantungan Plat, desain full color', 
      harga: 'Rp. 7.000' },
    
    { name: 'Kalender', 
      image: '/image/produk/kalender/moun3.jpg',
      deskripsi: 'Kalender 1 lembar tipe gantungan Plat, desain full color', 
      harga: 'Rp. 2000' },
    
    { name: 'Kalender', 
      image: '/image/produk/kalender/moun4.jpg',
      deskripsi: 'Kalender 12 lembar tipe gantungan Roll, desain full color', 
      harga: 'Rp. 12.000 '},
    
    { name: 'Kalender', 
      image: '/image/produk/kalender/moun5.jpg',
      deskripsi: 'Kalender 7 lembar tipe gantungan Plat, desain full color', 
      harga: 'Rp. 7.500' },
    ...
    <div className="Container-Page">
      <Helmet>
        ...
        <meta name="description" 
          content="Temukan Kalender eksklusif dan inovatif untuk Anda. Hubungi kami." />
        <meta name="keywords" 
          content="Kalemder, Calendar, Years Mounth " />
        <meta name="author" 
