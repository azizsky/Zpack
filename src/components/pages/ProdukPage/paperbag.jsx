...
const DusMakanan = () => {
  ...
  const products = [
    // produk 1
    { name: 'PaperBag', 
      image: '/image/produk/paperbag/bag.jpg',
      deskripsi: 'Paperbag ukuran Relative Laminasi dop/mate desain 2 color, sudah termasuk fininshing tinggal pakai', 
      harga: 'Rp. 3.000' },
    
    { name: 'PaperBag', 
      image: '/image/produk/paperbag/bag1.jpg',
      deskripsi: 'Paperbag ukuran Relative Laminasi dop/mate desain 2 color, sudah termasuk fininshing tinggal pakai', 
      harga: 'Rp. 2.000' },
    
    { name: 'PaperBag', 
      image: '/image/produk/paperbag/bag2.jpg',
      deskripsi: 'Paperbag ukuran Relative Laminasi dop/mate desain 2 color, sudah termasuk fininshing tinggal pakai', 
      harga: 'Rp. 5.000' },
    
    { name: 'PaperBag', 
      image: '/image/produk/paperbag/bag3.jpg',
      deskripsi: 'Paperbag ukuran Relative Laminasi dop/mate desain 2 color, sudah termasuk fininshing tinggal pakai', 
      harga: 'Rp. 3.000' },
    
    { name: 'PaperBag', 
      image: '/image/produk/paperbag/bag4.jpg',
      deskripsi: 'Paperbag ukuran Relative Laminasi dop/mate desain 2 color, sudah termasuk fininshing tinggal pakai', 
      harga: 'Rp. 4.000' },
    
    { name: 'PaperBag', 
      image: '/image/produk/paperbag/bag5.jpg',
      deskripsi: 'Paperbag ukuran Relative Laminasi dop/mate desain 2 color, sudah termasuk fininshing tinggal pakai', 
      harga: 'Rp. 3.000' },
  ...
  <HelmetProvider>
    <div className="Container-Page">
      <Helmet>
        <title>paperbag</title>
        <meta name="description" 
          content="Temukan berbagai jenis paperbag eksklusif dan inovatif untuk produk Anda. Hubungi kami." />
        <meta name="keywords" 
          content="paperbag, Kantong kertas, Kantong, Tas Kertas " />
        <meta name="author" 
